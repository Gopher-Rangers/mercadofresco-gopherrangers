...
func (_m *Service) Create(ctx context.Context, _a1 buyer.Buyer) (buyer.Buyer, error) {
...
func (_m *Service) GetAll(ctx context.Context) ([]buyer.Buyer, error) {
	ret := _m.Called(ctx)
...
func (_m *Service) GetById(ctx context.Context, id int) (buyer.Buyer, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Service) Update(ctx context.Context, _a1 buyer.Buyer) (buyer.Buyer, error) {
	ret := _m.Called(ctx, _a1)
